...
const renderTodo = async () => {
  try {
    const data = await fetch("https://todoapp-mauve-two.vercel.app/getAllTodos");
...
const createTodo = async () => {
  try {
    ...
    const res = await fetch("https://todoapp-mauve-two.vercel.app/createTodo", {
      method: "POST",
      headers: {
  ...
  try {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        const res = await fetch(`https://todoapp-mauve-two.vercel.app/delete/${id}`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
...
const liEditBtn = async (id) => {
  try {
    ...
    if (editedTodo) {
      const res = await fetch(`https://todoapp-mauve-two.vercel.app/update/${id}`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
